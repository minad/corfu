...
- Experimental: Use new function =set-frame-position-and-size= if available. See
  the patch on [[https://lists.gnu.org/archive/html/emacs-devel/2025-11/msg00322.html][emacs-devel]] by Martin Rudalics.
